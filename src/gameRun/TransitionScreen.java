...
public class TransitionScreen extends AbstractLevelSet {
	...
	public TransitionScreen(LevelManager lm, String name, int score) {
		username = name;
		this.lm = lm;
		this.score = score;
		init();
	...
	public void init() {
		...
		// sets background
		bg = new Background("/background/transitionbg.gif", 0.1);
